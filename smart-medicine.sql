/*
 ...
 Source Host           : 116.62.63.206:23030
...
-- ----------------------------
-- Table structure for first_aid_category
-- ----------------------------
...
CREATE TABLE `first_aid_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '急救指南分类表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of first_aid_category
-- ----------------------------
INSERT INTO `first_aid_category` VALUES (1, '运动损伤', 2, '2025-02-22 20:58:32', '2025-02-22 21:10:56');
INSERT INTO `first_aid_category` VALUES (2, '意外事故', 3, '2025-02-22 21:11:13', '2025-02-22 21:11:13');

-- ----------------------------
-- Table structure for first_aid_guide
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '急救指南内容表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of first_aid_guide
-- ----------------------------
INSERT INTO `first_aid_guide` VALUES (1, 1, '脱臼', '<p>12312322</p>', NULL, 123, '2025-02-22 21:34:15', '2025-02-22 22:18:58');
INSERT INTO `first_aid_guide` VALUES (2, 1, '骨折', '<p>12312322</p>', NULL, 123, '2025-02-22 21:34:15', '2025-02-22 22:18:58');
INSERT INTO `first_aid_guide` VALUES (3, 1, '疝气', '<p>12312322</p>', NULL, 123, '2025-02-22 21:34:15', '2025-02-22 22:18:58');
INSERT INTO `first_aid_guide` VALUES (4, 1, '韧带损伤', '<p>12312322</p>', NULL, 123, '2025-02-22 21:34:15', '2025-02-22 22:18:58');
INSERT INTO `first_aid_guide` VALUES (5, 1, '跌倒摔伤', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (6, 1, '颈部旧伤', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (7, 1, '脚踝扭伤', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (8, 1, '膝盖疼痛', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (9, 1, '肌肉酸痛', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (10, 2, '溺水', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (11, 2, '中暑', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (12, 2, '晒伤', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (13, 2, '冻伤', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (14, 2, '触电', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (15, 2, '雷击', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (16, 2, '擦伤割伤', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
INSERT INTO `first_aid_guide` VALUES (17, 2, '动物咬伤', '<p>123</p>', NULL, 123, '2025-02-23 03:36:35', '2025-02-23 03:36:39');
...
CREATE TABLE `history`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '用户搜索历史主键id',
  `user_id` int(0) NULL DEFAULT NULL COMMENT '用户ID',
  `keyword` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '搜索关键字',
  `operate_type` int(0) NULL DEFAULT NULL COMMENT '类型：1搜索，2科目，3药品',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `history` VALUES (160, 4, '病毒性感冒', 2, '2025-02-23 03:12:05', '2025-02-23 03:12:05');
...
CREATE TABLE `illness`  (
  ...
  `kind_id` int(0) NULL DEFAULT NULL COMMENT '疾病分类ID',
...
CREATE TABLE `illness_medicine`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '病和药品关联id',
  `illness_id` int(0) NULL DEFAULT NULL COMMENT '病id',
  `medicine_id` int(0) NULL DEFAULT NULL COMMENT '药品id',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `medical_news`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `news_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '医疗咨询名字',
  `news_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '医疗咨询关键字',
  `news_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '咨询的详细内容',
  `img_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '包含的图片地址',
  `relation_illness` int(0) NULL DEFAULT NULL COMMENT '关联的疾病id',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `medicine`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '药品主键ID',
  ...
  `medicine_type` int(0) NULL DEFAULT NULL COMMENT '药的类型，0西药，1中药，2中成药',
...
CREATE TABLE `pageview`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `pageviews` int(0) NULL DEFAULT NULL COMMENT '浏览量',
  `illness_id` int(0) NULL DEFAULT NULL COMMENT '病的id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `user`  (
  ...
  `role_status` int(0) NULL DEFAULT NULL COMMENT '角色状态，1管理员，0普通用户',
...
INSERT INTO `user` VALUES (6, '123', '123', '123', 123, '男', '1106591118@qq.com', '123', 0, 'https://moti-cloud-v2.oss-cn-beijing.aliyuncs.com/Snipaste_2022-05-01_15-37-01.png', '2025-02-23 03:33:27', '2025-02-23 03:33:27');
